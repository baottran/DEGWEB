...
ActiveRecord::Schema.define(version: 20170130194044) do
  ...
  create_table "inquiries", force: :cascade do |t|
    ...
    t.integer  "num_open_audatex_all"
    t.integer  "num_open_audatex_week"
    t.integer  "num_open_audatex_month"
    t.integer  "num_open_audatex_quarter"
    t.integer  "num_open_audatex_year"
    t.integer  "num_open_ccc_all"
    t.integer  "num_open_ccc_week"
    t.integer  "num_open_ccc_month"
    t.integer  "num_open_ccc_quar"
    t.integer  "num_open_ccc_year"
    t.integer  "num_open_mitchell_all"
    t.integer  "num_open_mitchell_week"
    t.integer  "num_open_mitchell_month"
    t.integer  "num_open_mitchell_quar"
    t.integer  "num_open_mitchell_year"
    t.integer  "num_resolved_audatex_all"
    t.integer  "num_resolved_audatex_week"
    t.integer  "num_resolved_audatex_month"
    t.integer  "num_resolved_audatex_quarter"
    t.integer  "num_resolved_audatex_year"
    t.integer  "num_resolved_ccc_all"
    t.integer  "num_resolved_ccc_week"
    t.integer  "num_resolved_ccc_month"
    t.integer  "num_resolved_ccc_quar"
    t.integer  "num_resolved_ccc_year"
    t.integer  "num_resolved_mitchell_all"
    t.integer  "num_resolved_mitchell_week"
    t.integer  "num_resolved_mitchell_month"
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.integer  "num_resolved_mitchell_quar"
    t.integer  "num_resolved_mitchell_year"
    t.integer  "num_original_mitchell_all"
    t.integer  "num_original_mitchell_week"
    t.integer  "num_original_mitchell_month"
    t.integer  "num_original_mitchell_quarter"
    t.integer  "num_original_mitchell_year"
    t.integer  "num_repeat_mitchell_all"
    t.integer  "num_repeat_mitchell_week"
    t.integer  "num_repeat_mitchell_month"
    t.integer  "num_repeat_mitchell_quarter"
    t.integer  "num_repeat_mitchell_year"
    t.integer  "num_original_ccc_all"
    t.integer  "num_original_ccc_week"
    t.integer  "num_original_ccc_month"
    t.integer  "num_original_ccc_quarter"
    t.integer  "num_original_ccc_year"
    t.integer  "num_repeat_ccc_all"
    t.integer  "num_repeat_ccc_week"
    t.integer  "num_repeat_ccc_month"
    t.integer  "num_repeat_ccc_quarter"
    t.integer  "num_repeat_ccc_year"
    t.integer  "num_original_audatex_all"
    t.integer  "num_original_audatex_week"
    t.integer  "num_original_audatex_month"
    t.integer  "num_original_audatex_quarter"
    t.integer  "num_original_audatex_year"
    t.integer  "num_repeat_audatex_all"
    t.integer  "num_repeat_audatex_week"
    t.integer  "num_repeat_audatex_month"
    t.integer  "num_repeat_audatex_quarter"
    t.integer  "num_repeat_audatex_year"
    t.integer  "avg_response_mitchell_week"
    t.integer  "avg_response_mitchell_month"
    t.integer  "avg_response_mitchell_quarter"
    t.integer  "avg_response_mitchell_year"
    t.integer  "avg_completion_mitchell_week"
    t.integer  "avg_completion_mitchell_month"
    t.integer  "avg_completion_mitchell_quarter"
    t.integer  "avg_completion_mitchell_year"
    t.integer  "avg_response_ccc_week"
    t.integer  "avg_response_ccc_month"
    t.integer  "avg_response_ccc_quarter"
    t.integer  "avg_response_ccc_year"
    t.integer  "avg_completion_ccc_week"
    t.integer  "avg_completion_ccc_month"
    t.integer  "avg_completion_ccc_quarter"
    t.integer  "avg_completion_ccc_year"
    t.integer  "avg_response_audatex_week"
    t.integer  "avg_response_audatex_month"
    t.integer  "avg_response_audatex_quarter"
    t.integer  "avg_response_audatex_year"
    t.integer  "avg_completion_audatex_week"
