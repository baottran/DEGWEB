class AddAdditionalFormFieldsToInquiries < ActiveRecord::Migration
  def change
    ...
    add_column :inquiries, :missing_area_of_vechicle, :string
    add_column :inquiries, :missing_area_of_vechicle_other_field, :string
    ...
    add_column :inquiries, :parts_area_of_vechicle, :string
    add_column :inquiries, :parts_area_of_vechicle_other_field, :string
    ...
    add_column :inquiries, :procedure_area_of_vechicle, :string
    add_column :inquiries, :procedure_area_of_vechicle_other_field, :string
    ...
    add_column :inquiries, :welded_area_of_vechicle, :string
    add_column :inquiries, :welded_area_of_vechicle_other_field, :string
    ...
    add_column :inquiries, :non_welded_area_of_vechicle, :string
    add_column :inquiries, :non_welded_area_of_vechicle_other_field, :string
    ...
    add_column :inquiries, :refinished_area_of_vechicle, :string
    add_column :inquiries, :refinished_area_of_vechicle_other_field, :string
